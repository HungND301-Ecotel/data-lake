...
const fakeReports: Report[] = [
    ...
    approvalTimeline: [
      {
        id: 1,
        status: "Tạo",
        description: "Nhân viên tạo báo cáo",
        approver: "Nguyễn A",
        approverAvatar: "https://i.pravatar.cc/150?img=1",
        approverPosition: "Nhân viên kinh doanh",
        createdAt: "2025-11-30",
        comment: "Khởi tạo báo cáo",
      },
      {
        id: 2,
        status: "Chờ duyệt",
        description: "Trưởng phòng duyệt",
        approver: "Trần B",
        approverAvatar: "https://i.pravatar.cc/150?img=2",
        approverPosition: "Trưởng phòng",
  ...
  },
  {
    ...
    attachments: [
      {
        id: 1,
        name: "Tồn kho tháng 11.xlsx",
        size: "3 MB",
        uploadedAt: "2025-11-29",
        s3Key: "s3_002",
      },
      {
        id: 2,
        name: "Chi tiết kho.csv",
        size: "1 MB",
        uploadedAt: "2025-11-29",
        s3Key: "s3_003",
      },
    ...
    approvalTimeline: [
      {
        ...
        approver: "Trần B",
        approverAvatar: "https://i.pravatar.cc/150?img=2",
        approverPosition: "Nhân viên kho",
        createdAt: "2025-11-29",
      },
      {
        id: 2,
      ...
      },
      {
        id: 3,
        status: "Đã duyệt",
        description: "Kế toán trưởng ký",
        approver: "Nguyễn D",
        approverAvatar: "https://i.pravatar.cc/150?img=4",
        approverPosition: "Kế toán trưởng",
        createdAt: "2025-12-01",
      },
    ],
  },
    ...
    approvalTimeline: [
      {
        ...
        approver: "Lê C",
        approverAvatar: "https://i.pravatar.cc/150?img=3",
        approverPosition: "Nhân viên Marketing",
        createdAt: "2025-11-28",
      },
      {
        id: 2,
        status: "Từ chối",
        description: "Trưởng phòng từ chối",
        approver: "Nguyễn E",
        approverAvatar: "https://i.pravatar.cc/150?img=5",
        approverPosition: "Trưởng phòng Marketing",
        createdAt: "2025-12-01",
        comment: "Cần bổ sung dữ liệu",
      },
    ],
  },
];
