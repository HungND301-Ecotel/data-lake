      ...
      <div className="sticky top-0 bg-white z-50 border-b pb-2 pt-2 mb-5 shadow-sm">
        <div className="flex justify-between items-center">
          ...
          <div className="flex gap-2">
            <button
              className="flex items-center gap-1 px-3 py-1.5 bg-[#39b6f9]! text-white rounded hover:bg-blue-700!"
        ...
        <div className="mb-6 p-4 border rounded bg-gray-50 shadow-sm">
          <div className="flex justify-between items-center">
            ...
            <div className="flex gap-2">
              {/* ADD TEXT */}
              <button
                className="px-3 py-1 bg-[#39b6f9]! text-white rounded hover:bg-blue-700!"
                onClick={() => {
